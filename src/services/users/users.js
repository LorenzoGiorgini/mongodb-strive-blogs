            ...
            .post(async (req, res) =>{
                ...
                try {
                    ...
                    if(createUser){
                        ...
                        res.status(400).send({ success: false , message: "Something Went Wrong in the creation of the user"})
...
router.route("/:userId")
                    .get(async (req, res) => {
                        ...
                        try {
                            ...
                            if(userById){
                                ...
                                res.status(404).send({ success: false , message: "User with that id Not Found"})
                    ...
                    .put(async (req, res) =>{
                        ...
                        try {
                            ...
                            const modifyedUser = await UsersModel.findByIdAndUpdate(req.params.userId, req.body, {new: true})
                    ...
                    .delete(async (req, res) =>{
                        ...
                        try {
                            const userByIdDelete = await UsersModel.findByIdAndDelete(req.params.userId)

                            if(userByIdDelete){
                                res.status(204).send({ success: true , deleted: "User has been deleted"})
